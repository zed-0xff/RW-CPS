...
//    [HarmonyPatch(typeof(GenClamor), "DoClamor", new Type[] {typeof(Thing), typeof(IntVec3), typeof(float), typeof(GenClamor.ClamorEffect)})]
//    public static class Patch_GenClamor {
